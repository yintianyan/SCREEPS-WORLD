...
describe("Resource Flow Graph", () => {
  describe("buildResourceFlow", () => {
    ...
    it("完全平衡", () => {
      const flow = buildResourceFlow("energy", 0, 100, 10000, 11000, 1000, 0, 0, 0, 0, 0, []);
    ...
    it("含损失分类", () => {
      ...
      const flow = buildResourceFlow("energy", 0, 100, 5000, 5870, 1000, 0, 0, 0, 0, 0, losses);
  ...
  describe("summarizeFlowGraph", () => {
    it("生成可读摘要", () => {
      const flow = buildResourceFlow("energy", 0, 100, 5000, 6000, 1000, 0, 0, 0, 0, 0, []);
  ...
  describe("verifyAccountingInvariant", () => {
    ...
    it("不平衡时 valid = false", () => {
      const flow = buildResourceFlow("energy", 0, 100, 5000, 5500, 1000, 0, 0, 0, 0, 0, []);
