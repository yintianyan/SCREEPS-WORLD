...
// ─── Telemetry Event Schema（1.md §31）────────────────────
...
/**
 * 构建 Prometheus 兼容的 metric name（1.md §22）。
...
/**
 * Telemetry 自身的 CPU 预算约束（1.md §36）。
